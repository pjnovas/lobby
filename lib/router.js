...
module.exports = function(app, lobby){
  ...
  app.get('/rooms/queues', notAllowed.bind('POST'));
  app.put('/rooms/queues', notAllowed.bind('POST'));
  app.del('/rooms/queues', notAllowed.bind('POST'));

  /* ROOM */
  app.get('/rooms/:roomId', getRoom, sendRoom);
  app.put('/rooms/:roomId', getRoom, updateRoom, sendRoom);
  app.del('/rooms/:roomId', getRoom, remove);

  app.post('/rooms/:roomId', notAllowed.bind('GET,PUT,DELETE'));
  ...
  app.get('/rooms/:roomId/users', notAllowed.bind('POST'));
  app.put('/rooms/:roomId/users', notAllowed.bind('POST'));
  app.del('/rooms/:roomId/users', notAllowed.bind('POST'));

  app.del('/rooms/:roomId/users/:userId', getRoom, removeUser);

  app.get('/rooms/:roomId/users/:userId', notAllowed.bind('DELETE'));
  app.post('/rooms/:roomId/users/:userId', notAllowed.bind('DELETE'));
  app.put('/rooms/:roomId/users/:userId', notAllowed.bind('DELETE'));
